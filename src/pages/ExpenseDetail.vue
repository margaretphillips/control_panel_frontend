      ...
      <q-card>
        <q-card-section>
          <div class="row wrap justify-between">
            ...
            <q-field class="col-4 q-pa-md">
              <q-input v-model="current_expense.duedate" label="Due on Date" />
            </q-field>
          </div>
        </q-card-section>
        ...
        <q-card-section>
          <div class="row justify-between">
            <div class="col text-left">
              <i class="material-icons q-ml-sm" @click="deleteExpense(current_expense._id)">delete</i>
            </div>

            <div class="col text-right">
              <i
                class="material-icons q-mr-lg"
