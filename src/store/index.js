  ...
  const Store = new Vuex.Store({
    ...
    actions: {
      ...
      getTransactions({
        ...
        ControlPanelService.getBudgetTransactions()
          .then(res => {
            // console.log(res.data)
      ...
      addTransaction({
        ...
        console.log("ADD TRANS  " + JSON.stringify(transaction))
        ControlPanelService.insertBudgetTransaction(transaction)
          .then(res => {
            commit('setTransactions', res.data)
          })
      },
      deleteTransaction({
        ...
        ControlPanelService.deleteBudgetTransaction(id)
          .then(res => {})
          .catch(err => console.log(err))
      }
    }
