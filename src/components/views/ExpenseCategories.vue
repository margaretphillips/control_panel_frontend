  ...
  <div>
    ...
    <q-card class="row full-width bg-primary q-pa-lg">
      <q-card-section class="col-12">
        <h5 class="text-grey q-ml-lg q-mb-lg">Expense Categories</h5>
        <q-card>
          <q-card-section>
            <q-list>
              <!-- <q-item>
...
import breadcrumbs from "layouts/breadcrumbs/categories.vue";
//import ExpenseList from "components/modules/expense-list.vue";
//mport ExpenseCategory from "components/forms/expenseCategory.vue";
